    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('site.player.all')}}
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12 col-md-12 col-xl-12">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-3 my-2 my-md-0">
                                <div class="d-flex align-items-center">
                                    <label class="mr-3 mb-0 d-none d-md-block">Team:</label>
                                    <select class="form-control" id="kt_datatable_search_team_id">
                                        <option value="">All</option>
                                    </select>
                                </div>
                            </div>
...
@section('scripts')
    <script !src="">
        ...
        var KTSelect2 = function() {
            ...
            var demos = function() {
                // basic
                $('#kt_datatable_search_competition_id,#kt_datatable_search_country_id,#kt_datatable_search_team_id').select2({
        ...
        var KTAppsrolesListDatatable = function() {
            ...
            var _demo = function() {
                ...
                $('#kt_datatable_search_parent_id').on('change', function() {
                    datatable.search($(this).val().toLowerCase(), 'parent_id');
                });
                $('#kt_datatable_search_team_id').on('change', function() {
                    datatable.search($(this).val().toLowerCase(), 'team_id');
                });
        ...
        function teams(competition){
            ...
            $.ajax({
                ...
                success:function (data){
                    ...
                    $('#kt_datatable_search_team_id').html(`
                                ${teams}
                            `);
                }
            })
