    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('site.matchEvent.all')}}
{{--                    <div class="text-muted pt-2 font-size-sm">Datatable initialized from HTML table</div>--}}
                </h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{route('dashboard.matches.events.create',$match->id)}}" class="btn btn-primary font-weight-bolder">
                ...
                var datatable = $('#kt_datatable').KTDatatable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            template: function(data) {
                                return data.player?data.player.first_name + ' ' +data.player.last_name :data.player_name ;
                            }
                        },
                        {
                            field: 'minute',
                            title: '{{__('site.matchEvent.minute')}}',
                            template: function(data) {
                                return data.minute ;
                            }
                        },
                        {
                            field: 'status',
                            title: '{{__('site.matchEvent.status')}}',
                            template: function(data) {
                                return data.status ;
                            }
                        },
