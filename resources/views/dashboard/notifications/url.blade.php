    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('site.notification.url')}}
        ...
        <div class="card-body">
            <form class="form" method="post" action="{{route('dashboard.notifications.url_post')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="url" class="col-form-label col-lg-3 col-sm-12">{{__('site.notification.url')}}</label>
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="input-group date" id="url" >
