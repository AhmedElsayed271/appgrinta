...
@section('content')
    <div class="card card-custom">
        ...
        <div class="card-body">
            <form class="form" method="post" action="{{route('dashboard.notifications.match_post')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                            <label for="match_id" class="col-form-label col-lg-3 col-sm-12">{{__('site.match.name')}}</label>
                            <div class=" col-lg-4 col-md-9 col-sm-12">
                                <select class="form-control select2" id="match_id" name="match_id">
                                    <option value=""></option>
                                    @foreach($matches as $key=>$value)
                                        <option value="{{$value->id}}" {{old('match_id') == $key ? 'selected' : '' }}>{{$value->team1->name .' vs ' .$value->team2->name }}</option>
                                    @endforeach
                                </select>
                                @error('match_id')
                                <div class="invalid-feedback" role="alert">
