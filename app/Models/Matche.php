...
class Matche extends Model
{
    ...
    {
        return '
        <a href="'.route('dashboard.matches.edit',$this->id) .'" class="btn btn-sm btn-primary btn-text-primary btn-hover-bg-success btn-icon mr-2" title="Edit details">
        ...
        <a href="'.route('dashboard.matches.events.index',$this->id) .'" class="btn btn-sm btn-primary btn-text-primary btn-hover-bg-success btn-icon mr-2" title="Edit details">
           <span class="svg-icon svg-icon-md">
        ...
        <form action="'.route('dashboard.matches.destroy',$this->id).'" method="post" style="    display: inline-block;">
