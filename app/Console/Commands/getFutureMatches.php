...
class getFutureMatches extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'future:matches';
     ...
     * @var string
     */
    protected $description = 'Get future matches and save it into database';
    ...
    public function handle()
    {
        ...
        $endDate = Carbon::createFromFormat('Y-m-d', date('Y-m-d', strtotime('+3 days')));
